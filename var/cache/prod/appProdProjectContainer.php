...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('G8E8yXp3r6', 0, (__DIR__.'/pools'));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'upboostn_upwork', 'user' => 'upboostn_upwork', 'password' => 'yU8FLx%c93$U', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = new DoctrineORMEntityManager_000000005f9132970000000037b8bbf7861d511ae4ea75266118ca584d727009(
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_13e7f16d29f1dea98711b9f73a2e00681a788c1671df4de5803016d5702123bc');
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jWm8oFsgnW', 0, 'kq3sVGIzS3ExyjrtE9FFxA', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('7pnr7scUsA', NULL, 'kq3sVGIzS3ExyjrtE9FFxA', ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TgPpaS4fMS', 0, 'kq3sVGIzS3ExyjrtE9FFxA', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59db4129817e06.75378779');
    }
...
class DoctrineORMEntityManager_000000005f9132970000000037b8bbf7861d511ae4ea75266118ca584d727009 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder59db4129caf8a021724574 = null;
    private $initializer59db4129caf96130414096 = null;
    private static $publicProperties59db4129caf62082021710 = array(
        
    );
    public function getConnection()
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'getConnection', array(), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->getConnection();
    }
    public function getMetadataFactory()
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'getMetadataFactory', array(), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->getMetadataFactory();
    }
    public function getExpressionBuilder()
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'getExpressionBuilder', array(), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->getExpressionBuilder();
    }
    public function beginTransaction()
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'beginTransaction', array(), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->beginTransaction();
    }
    public function getCache()
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'getCache', array(), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->getCache();
    }
    public function transactional($func)
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'transactional', array('func' => $func), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->transactional($func);
    }
    public function commit()
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'commit', array(), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->commit();
    }
    public function rollback()
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'rollback', array(), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->rollback();
    }
    public function getClassMetadata($className)
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'getClassMetadata', array('className' => $className), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->getClassMetadata($className);
    }
    public function createQuery($dql = '')
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'createQuery', array('dql' => $dql), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->createQuery($dql);
    }
    public function createNamedQuery($name)
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'createNamedQuery', array('name' => $name), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->createNamedQuery($name);
    }
    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->createNativeQuery($sql, $rsm);
    }
    public function createNamedNativeQuery($name)
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->createNamedNativeQuery($name);
    }
    public function createQueryBuilder()
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'createQueryBuilder', array(), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->createQueryBuilder();
    }
    public function flush($entity = null)
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'flush', array('entity' => $entity), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->flush($entity);
    }
    public function find($entityName, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->find($entityName, $id, $lockMode, $lockVersion);
    }
    public function getReference($entityName, $id)
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->getReference($entityName, $id);
    }
    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->getPartialReference($entityName, $identifier);
    }
    public function clear($entityName = null)
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'clear', array('entityName' => $entityName), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->clear($entityName);
    }
    public function close()
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'close', array(), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->close();
    }
    public function persist($entity)
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'persist', array('entity' => $entity), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->persist($entity);
    }
    public function remove($entity)
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'remove', array('entity' => $entity), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->remove($entity);
    }
    public function refresh($entity)
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'refresh', array('entity' => $entity), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->refresh($entity);
    }
    public function detach($entity)
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'detach', array('entity' => $entity), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->detach($entity);
    }
    public function merge($entity)
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'merge', array('entity' => $entity), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->merge($entity);
    }
    public function copy($entity, $deep = false)
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->copy($entity, $deep);
    }
    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->lock($entity, $lockMode, $lockVersion);
    }
    public function getRepository($entityName)
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'getRepository', array('entityName' => $entityName), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->getRepository($entityName);
    }
    public function contains($entity)
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'contains', array('entity' => $entity), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->contains($entity);
    }
    public function getEventManager()
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'getEventManager', array(), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->getEventManager();
    }
    public function getConfiguration()
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'getConfiguration', array(), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->getConfiguration();
    }
    public function isOpen()
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'isOpen', array(), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->isOpen();
    }
    public function getUnitOfWork()
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'getUnitOfWork', array(), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->getUnitOfWork();
    }
    public function getHydrator($hydrationMode)
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->getHydrator($hydrationMode);
    }
    public function newHydrator($hydrationMode)
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->newHydrator($hydrationMode);
    }
    public function getProxyFactory()
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'getProxyFactory', array(), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->getProxyFactory();
    }
    public function initializeObject($obj)
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'initializeObject', array('obj' => $obj), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->initializeObject($obj);
    }
    public function getFilters()
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'getFilters', array(), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->getFilters();
    }
    public function isFiltersStateClean()
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'isFiltersStateClean', array(), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->isFiltersStateClean();
    }
    public function hasFilters()
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'hasFilters', array(), $this->initializer59db4129caf96130414096);
        return $this->valueHolder59db4129caf8a021724574->hasFilters();
    }
    public function __construct($initializer)
    {
        $this->initializer59db4129caf96130414096 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, '__get', array('name' => $name), $this->initializer59db4129caf96130414096);
        if (isset(self::$publicProperties59db4129caf62082021710[$name])) {
            return $this->valueHolder59db4129caf8a021724574->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder59db4129caf8a021724574;
    ...
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer59db4129caf96130414096);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder59db4129caf8a021724574;
    ...
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, '__isset', array('name' => $name), $this->initializer59db4129caf96130414096);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder59db4129caf8a021724574;
    ...
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, '__unset', array('name' => $name), $this->initializer59db4129caf96130414096);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder59db4129caf8a021724574;
    ...
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, '__clone', array(), $this->initializer59db4129caf96130414096);
        $this->valueHolder59db4129caf8a021724574 = clone $this->valueHolder59db4129caf8a021724574;
    }
    public function __sleep()
    {
        $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, '__sleep', array(), $this->initializer59db4129caf96130414096);
        return array('valueHolder59db4129caf8a021724574');
    }
    ...
    {
        return $this->initializer59db4129caf96130414096;
    }
    public function initializeProxy()
    {
        return $this->initializer59db4129caf96130414096 && $this->initializer59db4129caf96130414096->__invoke($this->valueHolder59db4129caf8a021724574, $this, 'initializeProxy', array(), $this->initializer59db4129caf96130414096);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder59db4129caf8a021724574;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder59db4129caf8a021724574;
    }
}
